...
<f:view>
<h:form>
<h:panelGrid columns="2"  border="1" bgcolor="red">
  ...
  <h:commandButton value="submit" action="#{rohit.call}" ></h:commandButton>
  <h:commandButton value="back" action="gitbody"></h:commandButton>
  </h:panelGrid>
</h:form>
</f:view>
</div>
