...
<div class="bg-1">
  <div class="container text-center">
    <h3>Bamboo Configuration</h3>
    <img src="image/bamboo.png" class="img-circle" alt="Bird" width="350" height="350">
    <h3>Bamboo</h3>
  </div>
</div>
...
<h:commandButton value="Create Plan" action="delete"></h:commandButton>
<h:commandButton value="Create Stage" action="start"></h:commandButton>
